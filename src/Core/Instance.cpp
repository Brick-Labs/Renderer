...
Instance::Instance(const char* appName, const Version version, const uint32_t glfwExtensionCount,
    ...
    // Start macOS support (add Portability to requieredExtensions)
...
void Instance::checkExtensionSupport() const {
